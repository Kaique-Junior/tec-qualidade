  ...
  return (
    <div className="space-y-4">
      ...
      <button
        ...
        disabled={isLoading}
        className={cn(
          "w-full flex items-center justify-center gap-2 px-4 py-2 border border-gray-200 rounded-md shadow-sm text-xs font-medium text-gray-500 bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 disabled:opacity-50 disabled:cursor-not-allowed",
          className
        )}
      >
        {isLoading ? (
        ...
        Entrar como Convidado (Modo Dev)
      </button>
    </div>
  );
};