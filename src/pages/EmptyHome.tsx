...
/**
 * Página raiz vazia com header e texto temporário.
 * 
 * Deixando a rota raiz (/) vazia como solicitado.
 * Contém apenas o header e mensagem temporária.
 */
export default function EmptyHome() {
  ...
  const handleLogout = async () => {
    try {
      // Placeholder para logout - será implementado quando o hook estiver disponível
